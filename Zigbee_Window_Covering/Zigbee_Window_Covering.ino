...
#define MAX_LIFT 100  // centimeters from open position (0-900)
#define MIN_LIFT 0
...
void setup() {
  ...
  //zbCovering.setManufacturerAndModel("LUMI", "lumi.curtain.acn002");
  //bool ok = zbCovering.setManufacturerAndModel("LUMI", "lumi.curtain.acn002");
  bool ok = zbCovering.setManufacturerAndModel("TEST", "TEST123");
  Serial.printf("setManufacturerAndModel() => %s\n", ok ? "true" : "false");
  ...
  Serial.println("xxxx Adding ZigbeeWindowCovering endpoint to Zigbee Core");
